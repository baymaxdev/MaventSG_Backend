...
if (process.env.VCAP_SERVICES) {
    ...
    mongo = {
        ...
        port: 27017,
        ssl: false,
        url: 'mongodb://localhost:27017/mavent',
        username: '',
    };
}
...
module.exports = {
    mongodb: {
        ...
        adminUsername: process.env.ME_CONFIG_MONGODB_ADMINUSERNAME || 'aerobit',
    ...
    basicAuth: {
        ...
        password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'aerobit2016',
    },
